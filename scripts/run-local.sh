...
go build -o out/user ./user-service/cmd/app
go build -o out/project ./project-service/cmd/app
go build -o out/course ./course-service/cmd/app
go build -o out/registration ./registration-service/cmd/app
