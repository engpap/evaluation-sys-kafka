...
zip -r out/user-service.zip user-service client.properties go.work go.work.sum Dockerfile
rm Dockerfile

cp project-service/Dockerfile ./
zip -r out/project-service.zip project-service client.properties go.work go.work.sum Dockerfile
rm Dockerfile

cp registration-service/Dockerfile ./
zip -r out/registration-service.zip registration-service client.properties go.work go.work.sum Dockerfile
rm Dockerfile

cp course-service/Dockerfile ./
zip -r out/course-service.zip course-service client.properties go.work go.work.sum Dockerfile
rm Dockerfile